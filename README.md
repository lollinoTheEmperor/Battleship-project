...
* Gruber: One of the most challenging parts of the project was in the making of Ship_Radar since it was supposed to use a board of the game, which if passed in the constructor did not work as intended thus making it so i had to go through other methods not created by me to have the correct parameter get to the method call while not breaking anything. Also having to make sure everything in main worked as intended while learning what exactly every method was doing that had to be called was tedious but not too difficult.
* Larcher: The most challenging part for me was creating and connecting the interface with the backend. Although I had done a bit of interface work in high school, it was still difficult and new to me. Another challenge I faced was managing the ship_heal and how it worked.
